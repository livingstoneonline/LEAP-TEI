...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="foreign" >
		<span class="foreign diplomatic"><xsl:if test="@xml:lang">
			<xsl:attribute name="title"><xsl:value-of select="concat('lang: ', @xml:lang)"/></xsl:attribute>
		</xsl:if>
				<xsl:apply-templates/>
		</span>
...
<!-- EXAMPLE OF HANDLING persName WITH INFO IN ANOTHER FILE -->
	<!-- A global $people variable to store the people.xml document in. -->
