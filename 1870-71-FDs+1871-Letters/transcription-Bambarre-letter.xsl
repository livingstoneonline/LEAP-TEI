	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<!--<link rel="stylesheet" type="text/css" href="style-Bambarre-letter.css"/>-->
				<link rel="stylesheet" type="text/css" href="http://livingstoneonline.github.io/LEAP-XSLT/style-Bambarre-letter.css"/>
				<title>
